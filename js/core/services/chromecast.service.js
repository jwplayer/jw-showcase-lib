...
(function () {
    ...
    chromecast.$inject = ['$rootScope', '$timeout', '$interval', '$q'];

    function chromecast ($rootScope, $timeout, $interval, $q) {
        var self           = this;
        // Private variables
        var session        = null,
            eventCallbacks = {};
        ...
        function seek (position) {
            ...
            currentMedia.seek(seekRequest, defer.resolve, defer.reject);
